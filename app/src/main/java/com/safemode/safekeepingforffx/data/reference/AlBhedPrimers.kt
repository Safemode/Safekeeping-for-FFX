...
object AlBhedPrimers {
    ...
    val items: List<ReferenceItem> = listOf(
        ...
        primer(2, "II", "Besaid Village", "Inside the Crusaders' tent.", caution = Caution.Guarded("Dark Valefor"), stage = StoryStage.BESAID),
        ...
        primer(10, "X", "Mushroom Rock Road", "Down a secret pathway in the Valley area.", caution = Caution.Guarded("Dark Magus Sisters"), stage = StoryStage.MUSHROOM_ROCK_ROAD),
        ...
        primer(14, "XIV", "Thunder Plains Agency", "From Rin - tell him your study is going \"Okay\". Fallback: Bikanel Desert.", caution = Caution.Guarded("Dark Ixion"), stage = StoryStage.THUNDER_PLAINS),
        primer(15, "XV", "Macalania Woods", "Near the save sphere, by where O'aka XXIII stands."),
        primer(16, "XVI", "Lake Macalania", "To the left of Rin's Travel Agency.", caution = Caution.Guarded("Dark Shiva"), stage = StoryStage.LAKE_MACALANIA),
        primer(17, "XVII", "Bikanel Desert", "Sanubia Sands, central area.", caution = Caution.Guarded("Dark Ifrit"), stage = StoryStage.BIKANEL_ISLAND),
        primer(18, "XVIII", "Bikanel Desert", "Sanubia Sands, central area.", caution = Caution.Guarded("Dark Ifrit"), stage = StoryStage.BIKANEL_ISLAND),
        primer(19, "XIX", "Home - Entrance", "On the sand just outside the entrance to Home. Home is destroyed later - there is no second chance.", caution = Caution.Missable, stage = StoryStage.HOME),
        primer(20, "XX", "Home - Living Quarters", "Off the main hallway. Lost with Home.", caution = Caution.Missable, stage = StoryStage.HOME),
        primer(21, "XXI", "Home - Main Corridor", "In the Main Corridor. Lost with Home.", caution = Caution.Missable, stage = StoryStage.HOME),
        primer(22, "XXII", "Bevelle Temple", "In the Priest's Passage, after the wedding scene. You cannot return to Bevelle.", caution = Caution.Missable, stage = StoryStage.BEVELLE),
        primer(23, "XXIII", "Calm Lands", "In the northwest corner."),
        primer(24, "XXIV", "Remiem Temple", "In the northwest corner."),
        primer(25, "XXV", "Cavern of the Stolen Fayth", "In an offshoot near the second save point.", caution = Caution.Guarded("Dark Yojimbo"), stage = StoryStage.CALM_LANDS),
    ...
    private fun primer(
        ...
        shot: Int? = null,
        // Only set where it earns a section on the Missables Timeline. Staging every primer would
        // also switch on the story-order sort for this list, which is a separate decision.
